...
import { EmployerDashboardScreen } from "../../aiInterview/screens/EmployerDashboardScreen";
import { CandidateDashboardScreen } from "../../aiInterview/screens/CandidateFlowScreens";
...
export default function InterviewLegacyPage() {
  ...
  const isRecruiter = role === "recruiter" || role === "hr";
